...
public class FirstStepOfOrderForm extends BasePage{
        ...
        // локатор нажатия на кнопку выбора станции из выпадающего списка
        private By metroStationButton = By.xpath("//button[@class='Order_SelectOption__82bhS select-search__option'");
